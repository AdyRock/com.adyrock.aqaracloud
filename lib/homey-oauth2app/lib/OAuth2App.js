...
class OAuth2App extends Homey.App
{
    ...
    async onInit()
    {
        ...
        this.setOAuth2Config({ configId: 'china' });
        this.setOAuth2Config({ configId: 'korea' });
        this.setOAuth2Config({ configId: 'singapore' });
        this.setOAuth2Config({ configId: 'europe' });
        this.setOAuth2Config({ configId: 'russia' });
        this.setOAuth2Config({ configId: 'usa' });
    ...
    setOAuth2Config(
        {
            ...
            token = client.TOKEN,
            clientId = Homey.env[configId].CLIENT_ID,
            clientSecret = Homey.env[configId].CLIENT_SECRET,
            apiUrl = Homey.env[configId].API_URL,
            tokenUrl = Homey.env[configId].TOKEN_URL,
            authorizationUrl = Homey.env[configId].AUTHORIZATION_URL,
